      ...
      <div className="mx-auto max-w-7xl space-y-10">
        ...
        >
          <div className="space-y-3">
            ...
            <p className="max-w-xl text-base font-bold text-gray-600">
              {isFallback
                ...
                : t("landing.trending.regularDescription")}
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              onClick={refetch}
              disabled={loading}
              aria-label={t("landing.trending.refreshAria")}
            ...
            <Link
              ...
              aria-label={t("landing.top.viewFull")}
            >
              {t("common.viewAll")}
              <ArrowRight
                size={16}
        ...
        {isFallback && !loading && (
          ...
          >
            ...
            {t("landing.trending.fallbackNotice")}
          </motion.div>
        )}
        ...
        {error && creators.length > 0 && (
          <p className="text-xs font-bold text-gray-700 dark:text-gray-300">
            {t("landing.trending.weeklyError")}
          </p>
        )}
